package kr.or.kosta.product.service;
...
public class ProductListService {
	...
	public List<Product> searchProduct(String searchType,String searchValue) throws RuntimeException{
		List<Product> products = null;
		try {
			ProductDao dao = (ProductDao) factory.getDao("kr.or.kosta.product.dao.JdbcProductDao");
			products= dao.searchProduct(searchType, searchValue);
	...
	public List<Product> searchProductAll(String searchValue) throws RuntimeException{
		List<Product> products = null;
		try {
			ProductDao dao = (ProductDao) factory.getDao("kr.or.kosta.product.dao.JdbcProductDao");
			products= dao.searchProductAll(searchValue);
