/**
 * Amazing Slider - Responsive jQuery Slider and Image Scroller Copyright 2015
...
(function($) {
	$.fn.ashtml5lightbox = function(options) {
		...
		l = mk.length;
		for (i = 0; i < 5; i++)
			mk = mk.slice(0, l - 9 + i) + mk.slice(l - 8 + i);
		...
		inst.embedHTML5Video = function($container, src, autoplay) {
			...
			if (!inst.options.nativehtml5controls) {
				...
				$("video", $container).asHTML5VideoControls(
						inst.options.skinsfolder, inst, false, false)
			}
		};
				...
				this.container
						.bind(
								...
								function(event, prev, cur) {
									...
									var textHeadCss = "<style type='text/css' data-creator='amazingslidercreator"
											+ instance.id
		...
		this
				.each(function() {
					...
					if ($(this).data("textformat")
							&& typeof AMAZINGSLIDER_TEXT_EFFECT_FORMATS !== "undefined")
						if ($(this).data("textformat") in AMAZINGSLIDER_TEXT_EFFECT_FORMATS)
							this.options = $.extend({},
									AMAZINGSLIDER_TEXT_EFFECT_FORMATS[$(this)
											.data("textformat")], this.options);
					if ($(this).data("skin")
							&& typeof AMAZINGSLIDER_SKIN_OPTIONS !== "undefined")
						if ($(this).data("skin") in AMAZINGSLIDER_SKIN_OPTIONS)
							this.options = $.extend({},
									AMAZINGSLIDER_SKIN_OPTIONS[$(this).data(
											"skin")], this.options);
					var instance = this;
					...
					var defaultOptions = {
						...
						wimagedefault : "",
						wposcss : "display:block !important;position:absolute;top:6px;left:6px;visibility:hidden;z-index:999999 !important;",
